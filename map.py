# hard coded values below are rescued from print logs after a 503 on a previous traversal.
# eventually we'll be pulling the data out of a txt file (once a full traversal completes.)
